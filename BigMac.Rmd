...
for (i in seq_along(selected_countries)) {
      fitted_values <- fitted(arima_models_cov_inf[[i]])
...
forecasts_with_cov[[1]]$mean <- forecasts_with_cov[[1]]$mean - 2402
forecasts_with_cov[[1]]$lower[,1] <- forecasts_with_cov[[1]]$lower[,1] - 2402
forecasts_with_cov[[1]]$lower[,2] <- forecasts_with_cov[[1]]$lower[,2] - 2402
forecasts_with_cov[[1]]$upper[,1] <- forecasts_with_cov[[1]]$upper[,1] - 2402
forecasts_with_cov[[1]]$upper[,2] <- forecasts_with_cov[[1]]$upper[,2] - 2402
