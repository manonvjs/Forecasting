...
# Create a scatterplot of the local price against the date for each country
ggplot(bigmac, aes(x=date, y=local_price, color=country)) + 
  geom_point() + 
  scale_x_date(date_labels = "%Y", date_breaks = "2 years") +
  labs(x="Year", y="Local Price", title="Local Price of Big Mac over Time by Country") +
  theme_bw()
```
...
# Create a violin plot of the local price by country
ggplot(bigmac, aes(x=country, y=local_price)) +
  geom_violin(fill="blue", color="black", alpha=0.5) +
  labs(x="Country", y="Local Price", title="Distribution of Local Price of Big Mac by Country") +
  theme_bw() +
