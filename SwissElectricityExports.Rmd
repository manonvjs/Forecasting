...
test_data <- window(ts_data, start = c(2020, 1))
  ...
  #ets_anm <- ets(train_data, model = "ANM")
  ...
  #ets_anm_forecast <- forecast(ets_anm, h=length(test_data))
  ...
  #accuracy_ets_anm <- accuracy(ets_anm_forecast, test_data)
  ...
  accuracy_results <- list(
    ...
    ETS_MNM=accuracy_ets_mnm,
    #ETS_ANM=accuracy_ets_anm,
...
# Example usage
accuracy_results_germany <- compare_models(ts_germany)

accuracy_results_germany
